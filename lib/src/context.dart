...
class Context {
    ...
    late final Z3_context _ctx;
    late final Z3_config _config;

    Context(this._lookup, this._config) {
      _ctx = _lookup.Z3_mk_context_rc(_config);
      _init();
    }
     ...
     **/
    Context.fromSettings(Map<String, String> settings) {
            long cfg = _lookup.mkConfig();
            for (Map.Entry<String, String> kv in settings.entrySet()) {
                _lookup.setParamValue(cfg, kv.getKey(), kv.getValue());
            }
            _ctx = _lookup.mkContextRc(cfg);
            _lookup.delConfig(cfg);
            init();
    }
    ...
    void _init() {
        ...
        //TODO:implement
        // Native.setInternalErrorHandler(_m_ctx);
    }
    ...
    BoolSort? _m_boolSort = null;
    IntSort? _m_intSort = null;
    RealSort? _m_realSort = null;
    SeqSort<CharSort>? _m_stringSort = null;
     ...
     **/
    <D extends Sort, R extends Sort> ArraySort<D, R> mkArraySort(D domain, R range)
    {
     ...
     * Create a new array sort.
     **/
    <R extends Sort> ArraySort<Sort, R> mkArraySort(Sort[] domains, R range)
    {
     ...
     **/
    <R extends Sort> SeqSort<R> mkSeqSort(R s)
    {
     ...
     **/
    <R extends Sort> ReSort<R> mkReSort(R s)
    {
     ...
     **/
    TupleSort mkTupleSort(Symbol name, Symbol[] fieldNames,
            Sort[] fieldSorts)
    {
     ...
     **/
    <R> EnumSort<R> mkEnumSort(Symbol name, Symbol... enumNames)
     ...
     * Create a new enumeration sort.
     **/
    <R> EnumSort<R> mkEnumSort(String name, String... enumNames)
     ...
     **/
    <R extends Sort> ListSort<R> mkListSort(Symbol name, R elemSort)
    {
        checkContextMatch(name);
     ...
     * Create a new list sort.
     **/
    <R extends Sort> ListSort<R> mkListSort(String name, R elemSort)
    {
        checkContextMatch(elemSort);
     ...
     **/
    <R> FiniteDomainSort<R> mkFiniteDomainSort(Symbol name, long size)
     ...
     * Create a new finite domain sort.
     **/
    <R> FiniteDomainSort<R> mkFiniteDomainSort(String name, long size)
     ...
     * declared.
     **/
    <R> Constructor<R> mkConstructor(Symbol name, Symbol recognizer,
     ...
     * Create a datatype constructor. 
     **/
    <R> Constructor<R> mkConstructor(String name, String recognizer,
     ...
     **/
    <R> DatatypeSort<R> mkDatatypeSort(Symbol name, Constructor<R>[] constructors)
    {
        checkContextMatch(name);
     ...
     * Create a new datatype sort.
     **/
    <R> DatatypeSort<R> mkDatatypeSort(String name, Constructor<R>[] constructors)
     ...
     **/
    <F extends Sort, R extends Sort> Expr<R> mkUpdateField(FuncDecl<F> field, Expr<R> t, Expr<F> v)
        throws Z3Exception
    {
     ...
     **/
    <R extends Sort> FuncDecl<R> mkFuncDecl(Symbol name, Sort[] domain, R range)
    {
        checkContextMatch(name);
        checkContextMatch(domain);
        checkContextMatch(range);
     ...
     * Creates a new function declaration.
     **/
    <R extends Sort> FuncDecl<R> mkFuncDecl(String name, Sort[] domain, R range)
     ...
     **/
    <R extends Sort> FuncDecl<R> mkRecFuncDecl(Symbol name, Sort[] domain, R range)
    {
        checkContextMatch(name);
        checkContextMatch(domain);
        checkContextMatch(range);
     ...
     */
    <R extends Sort> void AddRecDef(FuncDecl<R> f, Expr<?>[] args, Expr<R> body)
    {
        checkContextMatch(f);
     ...
     * @see #mkFuncDecl(String,Sort[],Sort)
     **/
    <R extends Sort> FuncDecl<R> mkFreshFuncDecl(String prefix, Sort[] domain, R range)
     ...
     **/
    <R extends Sort> FuncDecl<R> mkConstDecl(Symbol name, R range)
    {
        checkContextMatch(name);
        checkContextMatch(range);
     ...
     * Creates a new constant function declaration.
     **/
    <R extends Sort> FuncDecl<R> mkConstDecl(String name, R range)
    {
        checkContextMatch(range);
     ...
     * @see #mkFuncDecl(String,Sort[],Sort)
     **/
    <R extends Sort> FuncDecl<R> mkFreshConstDecl(String prefix, R range)
     ...
     **/
    <R extends Sort> Expr<R> mkBound(int index, R ty)
    {
        return (Expr<R>) Expr.create(this,
     ...
     * {@code name}.
     **/
    <R extends Sort> Expr<R> mkConst(Symbol name, R range)
    {
        checkContextMatch(name);
        checkContextMatch(range);
     ...
     * {@code name}.
     **/
    <R extends Sort> Expr<R> mkConst(String name, R range)
    {
     ...
     **/
    <R extends Sort> Expr<R> mkFreshConst(String prefix, R range)
    {
        checkContextMatch(range);
        return (Expr<R>) Expr.create(this,
     ...
     **/
    <R extends Sort> Expr<R> mkConst(FuncDecl<R> f)
    {
  ...
  //    **/
  //   <R extends Sort> Expr<R> mkITE(Expr<BoolSort> t1, Expr<? extends R> t2, Expr<? extends R> t3)
  //   {
  ...
  //    **/
  //   <R extends ArithSort> ArithExpr<R> mkUnaryMinus(Expr<R> t)
  //   {
  //       checkContextMatch(t);
  //       return (ArithExpr<R>) Expr.create(this,
  ...
  //    * Create an expression representing {@code t1 / t2}.
  //    **/
  //   <R extends ArithSort> ArithExpr<R> mkDiv(Expr<? extends R> t1, Expr<? extends R> t2)
  //   {
  //       checkContextMatch(t1);
  //       checkContextMatch(t2);
  ...
  //    * Create an expression representing {@code t1 ^ t2}.
  //    **/
  //   <R extends ArithSort> ArithExpr<R> mkPower(Expr<? extends R> t1,
  //           Expr<? extends R> t2)
  //   {
  //       checkContextMatch(t1);
  //       checkContextMatch(t2);
  ...
  //    **/
  //   BoolExpr mkBVAddNoOverflow(Expr<BitVecSort> t1, Expr<BitVecSort> t2,
  //           boolean isSigned)
  //   {
  //       checkContextMatch(t1);
  //       checkContextMatch(t2);
  ...
  //    * Remarks:  The arguments must be of bit-vector sort. 
  //    **/
  //   BoolExpr mkBVSubNoUnderflow(Expr<BitVecSort> t1, Expr<BitVecSort> t2,
  //           boolean isSigned)
  //   {
  //       checkContextMatch(t1);
  //       checkContextMatch(t2);
  ...
  //    * Remarks:  The arguments must be of bit-vector sort. 
  //    **/
  //   BoolExpr mkBVMulNoOverflow(Expr<BitVecSort> t1, Expr<BitVecSort> t2,
  //           boolean isSigned)
  //   {
  //       checkContextMatch(t1);
  //       checkContextMatch(t2);
  ...
  //    **/
  //   <D extends Sort, R extends Sort> ArrayExpr<D, R> mkArrayConst(Symbol name, D domain, R range)
  ...
  //    * Create an array constant.
  //    **/
  //   <D extends Sort, R extends Sort> ArrayExpr<D, R> mkArrayConst(String name, D domain, R range)
  ...
  //    * @see #mkStore
  //    **/
  //   <D extends Sort, R extends Sort> Expr<R> mkSelect(Expr<ArraySort<D, R>> a, Expr<D> i)
  //   {
  //       checkContextMatch(a);
  //       checkContextMatch(i);
  //       return (Expr<R>) Expr.create(
  ...
  //    * @see #mkStore
  //    **/
  //   <R extends Sort> Expr<R> mkSelect(Expr<ArraySort<Sort, R>> a, Expr<?>[] args)
  //   {
  //       checkContextMatch(a);
  //       checkContextMatch(args);
  //       return (Expr<R>) Expr.create(
  ...
  //    **/
  //   <D extends Sort, R extends Sort> ArrayExpr<D, R> mkStore(Expr<ArraySort<D, R>> a, Expr<D> i, Expr<R> v)
  //   {
  //       checkContextMatch(a);
  //       checkContextMatch(i);
  //       checkContextMatch(v);
  ...
  //    **/
  //   <R extends Sort> ArrayExpr<Sort, R> mkStore(Expr<ArraySort<Sort, R>> a, Expr<?>[] args, Expr<R> v)
  //   {
  //       checkContextMatch(a);
  //       checkContextMatch(args);
  //       checkContextMatch(v);
  ...
  //    *
  //    **/
  //   <D extends Sort, R extends Sort> ArrayExpr<D, R> mkConstArray(D domain, Expr<R> v)
  //   {
  //       checkContextMatch(domain);
  //       checkContextMatch(v);
  ...
  //    * range value. 
  //    **/
  //   <D extends Sort, R extends Sort> Expr<R> mkTermArray(Expr<ArraySort<D, R>> array)
  //   {
  ...
  //    **/
  //   <D extends Sort, R extends Sort> Expr<D> mkArrayExt(Expr<ArraySort<D, R>> arg1, Expr<ArraySort<D, R>> arg2)
  //   {
  ...
  //    * Create a set type.
  //    **/
  //   <D extends Sort> SetSort<D> mkSetSort(D ty)
  //   {
  ...
  //    * Create an empty set.
  //    **/
  //   <D extends Sort> ArrayExpr<D, BoolSort> mkEmptySet(D domain)
  //   {
  //       checkContextMatch(domain);
  ...
  //    * Create the full set.
  //    **/
  //   <D extends Sort> ArrayExpr<D, BoolSort> mkFullSet(D domain)
  //   {
  //       checkContextMatch(domain);
  //       return (ArrayExpr<D, BoolSort>) Expr.create(this,
  ...
  //    **/
  //   <D extends Sort> ArrayExpr<D, BoolSort> mkSetAdd(Expr<ArraySort<D, BoolSort>> set, Expr<D> element)
  //   {
  ...
  //    **/
  //   <D extends Sort> ArrayExpr<D, BoolSort> mkSetDel(Expr<ArraySort<D, BoolSort>> set, Expr<D> element)
  //   {
  //       checkContextMatch(set);
  //       checkContextMatch(element);
  //       return (ArrayExpr<D, BoolSort>)Expr.create(this,
  ...
  //    **/
  //   <D extends Sort> ArrayExpr<D, BoolSort> mkSetDifference(Expr<ArraySort<D, BoolSort>> arg1, Expr<ArraySort<D, BoolSort>> arg2)
  //   {
  //       checkContextMatch(arg1);
  //       checkContextMatch(arg2);
  //       return (ArrayExpr<D, BoolSort>) Expr.create(this,
  ...
  //    **/
  //   <D extends Sort> ArrayExpr<D, BoolSort> mkSetComplement(Expr<ArraySort<D, BoolSort>> arg)
  //   {
  ...
  //    **/
  //   <D extends Sort> BoolExpr mkSetMembership(Expr<D> elem, Expr<ArraySort<D, BoolSort>> set)
  //   {
  ...
  //    **/
  //   <D extends Sort> BoolExpr mkSetSubset(Expr<ArraySort<D, BoolSort>> arg1, Expr<ArraySort<D, BoolSort>> arg2)
  //   {
  //       checkContextMatch(arg1);
  //       checkContextMatch(arg2);
  //       return (BoolExpr) Expr.create(this,
  ...
  //   */
  //   <R extends Sort> SeqExpr<R> mkEmptySeq(R s)
  //   {
  //       checkContextMatch(s);
  ...
  //    */
  //   <R extends Sort> SeqExpr<R> mkUnit(Expr<R> elem)
  //   {
  //       checkContextMatch(elem);
  ...
  //    */
  //   <R extends Sort> IntExpr mkLength(Expr<SeqSort<R>> s)
  //   {
  //       checkContextMatch(s);
  ...
  //    */
  //   <R extends Sort> BoolExpr mkPrefixOf(Expr<SeqSort<R>> s1, Expr<SeqSort<R>> s2)
  //   {
  ...
  //    */
  //   <R extends Sort> BoolExpr mkSuffixOf(Expr<SeqSort<R>> s1, Expr<SeqSort<R>> s2)
  //   {
  //       checkContextMatch(s1, s2);
  ...
  //    */
  //   <R extends Sort> BoolExpr mkContains(Expr<SeqSort<R>> s1, Expr<SeqSort<R>> s2)
  //   {
  //       checkContextMatch(s1, s2);
  ...
  //    */
  //   <R extends Sort> SeqExpr<R> mkAt(Expr<SeqSort<R>> s, Expr<IntSort> index)
  //   {
  ...
  //    */
  //   <R extends Sort> Expr<R> mkNth(Expr<SeqSort<R>> s, Expr<IntSort> index)
  //   {
  //       checkContextMatch(s, index);
  ...
  //    * Extract subsequence.
  //    */
  //   <R extends Sort> SeqExpr<R> mkExtract(Expr<SeqSort<R>> s, Expr<IntSort> offset, Expr<IntSort> length)
  //   {
  ...
  //    */
  //   <R extends Sort> IntExpr mkIndexOf(Expr<SeqSort<R>> s, Expr<SeqSort<R>> substr, Expr<IntSort> offset)
  //   {
  ...
  //    */
  //   <R extends Sort> SeqExpr<R> mkReplace(Expr<SeqSort<R>> s, Expr<SeqSort<R>> src, Expr<SeqSort<R>> dst)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkToRe(Expr<SeqSort<R>> s)
  //   {
  //       checkContextMatch(s);
  ...
  //    */
  //   <R extends Sort> BoolExpr mkInRe(Expr<SeqSort<R>> s, Expr<ReSort<R>> re)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkStar(Expr<ReSort<R>> re)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkPower(Expr<ReSort<R>> re, int n)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkLoop(Expr<ReSort<R>> re, int lo, int hi)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkLoop(Expr<ReSort<R>> re, int lo)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkPlus(Expr<ReSort<R>> re)
  //   {
  //       checkContextMatch(re);
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkOption(Expr<ReSort<R>> re)
  //   {
  //       checkContextMatch(re);
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkComplement(Expr<ReSort<R>> re)
  //   {
  //       checkContextMatch(re);
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkDiff(Expr<ReSort<R>> a, Expr<ReSort<R>> b)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkEmptyRe(R s)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkFullRe(R s)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkAllcharRe(R s)
  //   {
  ...
  //    */
  //   <R extends Sort> ReExpr<R> mkRange(Expr<SeqSort<CharSort>> lo, Expr<SeqSort<CharSort>> hi)
  //   {
  ...
  //    **/
  //   <R extends Sort> Expr<R> mkNumeral(String v, R ty)
  //   {
  //       checkContextMatch(ty);
  //       return (Expr<R>) Expr.create(this,
  ...
  //    **/
  //   <R extends Sort> Expr<R> mkNumeral(int v, R ty)
  //   {
  //       checkContextMatch(ty);
  ...
  //    * @return A Term with value {@code v} and type {@code ty}
  //    **/
  //   <R extends Sort> Expr<R> mkNumeral(long v, R ty)
  //   {
  //       checkContextMatch(ty);
  //       return (Expr<R>) Expr.create(this,
  ...
  //    * with index 1, etc. 
  //    **/
  //   Quantifier mkForall(Sort[] sorts, Symbol[] names, Expr<BoolSort> body,
  ...
  //    **/
  //   Quantifier mkForall(Expr<?>[] boundConstants, Expr<BoolSort> body, int weight,
  ...
  //    * @see #mkForall(Sort[],Symbol[],Expr<BoolSort>,int,Pattern[],Expr<?>[],Symbol,Symbol)
  //    **/
  //   Quantifier mkExists(Sort[] sorts, Symbol[] names, Expr<BoolSort> body,
  //                              int weight, Pattern[] patterns, Expr<?>[] noPatterns,
  //                              Symbol quantifierID, Symbol skolemID)
  //   {
  ...
  //    * @see #mkForall(Sort[],Symbol[],Expr<BoolSort>,int,Pattern[],Expr<?>[],Symbol,Symbol)
  //    **/
  //   Quantifier mkExists(Expr<?>[] boundConstants, Expr<BoolSort> body, int weight,
  //                              Pattern[] patterns, Expr<?>[] noPatterns, Symbol quantifierID,
  //                              Symbol skolemID)
  //   {
  ...
  //    * @see #mkForall(Sort[],Symbol[],Expr<BoolSort>,int,Pattern[],Expr<?>[],Symbol,Symbol)
  //    **/
  //   Quantifier mkQuantifier(boolean universal, Sort[] sorts,
  ...
  //    * @see #mkForall(Sort[],Symbol[],Expr<BoolSort>,int,Pattern[],Expr<?>[],Symbol,Symbol)
  //    **/
  //   Quantifier mkQuantifier(boolean universal, Expr<?>[] boundConstants,
  ...
  //    * @param body the body of the quantifier.
  //    **/
  //    <R extends Sort> Lambda<R> mkLambda(Sort[] sorts, Symbol[] names, Expr<R> body)
  //    {
  ...
  //    **/
  //    <R extends Sort> Lambda<R> mkLambda(Expr<?>[] boundConstants, Expr<R> body)
  //    {
  ...
  //    }
     ...
     * @see Sort#toString
     **/
    void setPrintMode(int value)
    {
        _lookup.Z3_set_ast_print_mode(nCtx(), value);
    }
  ...
  //    **/
  //   String benchmarkToSMTString(String name, String logic,
  ...
  //    * last scope level.
  //    **/
  //   BoolExpr[] parseSMTLIB2String(String str, Symbol[] sortNames,
  ...
  //    **/
  //   BoolExpr[] parseSMTLIB2File(String fileName, Symbol[] sortNames,
  //           Sort[] sorts, Symbol[] declNames, FuncDecl<?>[] decls)
  //   {
  //       int csn = Symbol.arrayLength(sortNames);
  //       int cs = Sort.arrayLength(sorts);
  ...
  //    */
  //   <R extends Sort> FuncDecl<BoolSort> mkLinearOrder(R sort, int index) {
  ...
  //    * @param sort The sort of the order.
  //    */
  //   <R extends Sort> FuncDecl<BoolSort> mkPartialOrder(R sort, int index) {
  //       return (FuncDecl<BoolSort>) FuncDecl.create(
  //               this,
